...
@section('content')
    @push('css')
        ...
        <link rel="stylesheet" href="{{ url('admin/css/tempusdominus-bootstrap-4.min.css') }}">
        <link rel="stylesheet" href="{{ url('admin/css/icheck-bootstrap.min.css') }}">
        <link rel="stylesheet" href="{{ url('admin/css/jqvmap.min.css') }}">
        ...
        <link rel="stylesheet" href="{{ url('admin/css/summernote-bs4.min.css') }}">
    @endpush
    ...
    @push('js')
        ...
        <script src="{{ url('admin/js/sparkline.js') }}"></script>
        <script src="{{ url('admin/js/jquery.vmap.min.js') }}"></script>
        <script src="{{ url('admin/js/jquery.vmap.usa.js') }}"></script>
        <script src="{{ url('admin/js/jquery.knob.min.js') }}"></script>
        <script src="{{ url('admin/js/moment.min.js') }}"></script>
        <script src="{{ url('admin/js/daterangepicker.js') }}"></script>
        <script src="{{ url('admin/js/tempusdominus-bootstrap-4.min.js') }}"></script>
